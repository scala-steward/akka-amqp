...
object dependencies {
  ...
  def AmqpClient = "com.rabbitmq" % "amqp-client" % "3.1.3"   													  // ApacheV2

 
  def AkkaAgent = "com.typesafe.akka" % "akka-agent_2.10" % "2.2.0"

  def Specs2      = "org.specs2"                 % "specs2_2.10"              % "1.13"        % "test"  // MIT
  def JUnit = "junit" % "junit" % "4.7" % "test"   																 // Common Public License 1.0
  def AkkaTestKit = "com.typesafe.akka" % "akka-testkit_2.10" % "2.2.0" % "test"
