...
object dependencies {
  ...
  def AmqpClient = "com.rabbitmq" % "amqp-client" % "3.6.1"                               // ApacheV2


  def AkkaAgent = "com.typesafe.akka" % "akka-agent_2.11" % "2.4.4"

  def Specs2      = "org.specs2"                 % "specs2-core_2.11"              % "3.7.2"        % "test"  // MIT
  def JUnit = "junit" % "junit" % "4.11" % "test"                                   // Common Public License 1.0
  def AkkaTestKit = "com.typesafe.akka" % "akka-testkit_2.11" % "2.4.4" % "test"
